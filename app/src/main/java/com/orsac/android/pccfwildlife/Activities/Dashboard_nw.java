...
public class Dashboard_nw extends AppCompatActivity implements DashboardContract.view {

    SessionManager session;
    TextView profileName, desig,version_name;
    public static final String LOGIN_SHARED = "logindetails";
    DrawerLayout drawer;
    ImageView menu,back_img,close_img,download_report;
    BottomNavigationView bottom_navigation;
    public String token="",checkInternet_status="",value="",division_nm="",userId="",userNm="",guestFlag="";
    SQLiteDatabase mDb;
    Cursor c=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dash_board_new);
        ...
        initData();
            try {
                ...
                replaceFragment(R.id.nav_home,new ReportingFragment(guestFlag),"reporting_frag");
            ...
            profile_img.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    try {
                        ...
                        popup = new PopupMenu(Dashboard_nw.this, profile_img);
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                ...
                                switch (item.getItemId()) {
                                    case R.id.nav_profile:
                                        ...
                                        Intent profile_intent=new Intent(Dashboard_nw.this,ProfileActivity.class);
                                        startActivity(profile_intent);

                                        break;

                                    case R.id.nav_update_local_data:
//                                Toast.makeText(Dashboard_nw.this, "Updating...", Toast.LENGTH_LONG).show();
//                                callUpdate(checkInternet_status,Dashboard_nw.this);
                                        dashboard_presenter.load_Update(checkInternet_status,Dashboard_nw.this);
                                        break;

                                    case R.id.changePwd:
//                                        Toast.makeText(Dashboard_nw.this, "Change password !", Toast.LENGTH_SHORT).show();
                                        callChangePasswordDialog(Dashboard_nw.this);
                                        break;
                                    case R.id.changeUserId:
//                                        Toast.makeText(Dashboard_nw.this, "Change UserId !", Toast.LENGTH_SHORT).show();
                                        callChangeUserIdDialog(Dashboard_nw.this);
                                        break;

                                    case R.id.nav_logout:
//                                call_logout(Dashboard_nw.this,"Do you want to logout the app ?","Logout");
                                        dashboard_presenter.call_logout(Dashboard_nw.this,"Do you want to logout the app ?","Logout",session);
                                        break;
    ...
    private void initData() {
        ...
        session = new SessionManager(Dashboard_nw.this);
        ...
        dashboard_presenter=new DashboardPresenter(Dashboard_nw.this,this,Dashboard_nw.this);
...
//        Toast.makeText(this, "---"+division_nm+"==="+userId, Toast.LENGTH_SHORT).show();
        ...
        //create div_master
        mDb.execSQL(SplashScreen.CREATE_DIV_TABLE);
        mDb.execSQL(SplashScreen.CREATE_RANGE_TABLE);
        mDb.execSQL(SplashScreen.CREATE_SECTION_TABLE);
        mDb.execSQL(SplashScreen.CREATE_BEAT_TABLE);

        try {
            c = mDb.rawQuery("SELECT * from " + SplashScreen.DIV_TABLE_NAME + "", null);
            int count = c.getCount();
            if (count < 1) {

                //Call service to sync data
//            callUpdate(checkInternet_status,Dashboard_nw.this); //Run for first time only
                dashboard_presenter.load_Update(checkInternet_status,Dashboard_nw.this);//Run for first time only
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.reporting_id://Reporting Fragment
                                ...
                                replaceFragment(R.id.reporting_id,new ReportingFragment(guestFlag),"reporting_frag");//guestFlag is for checking user is offline or not
                                break;
    ...
    private void replaceFragment(int itemId,Fragment fragmentt,String tag) {
        ...
        //initializing the fragment object which is selected
                ...
                ft.replace(R.id.main, fragmentt,tag);
...
//        replaceFragment(R.id.reporting_id,new ReportingFragment());
//        this.doubleBackToExitPressedOnce = true;
            ...
            toolbar_txt.setText(R.string.app_name);
            if (currentFragment.getTag().equals("reporting_frag")) {
                //for onbackpress in offline
                if (guestFlag.equalsIgnoreCase("guest")){
                    Intent intent=new Intent(Dashboard_nw.this,LoginActivityNewGajaBandhu.class);
...
//            replaceFragment(R.id.reporting_id,new ReportingFragment(),"reporting_frag");
            ...
            else if (currentFragment.getTag().equals("dashboard_frag")) {

                replaceFragment(R.id.reporting_id,new ReportingFragment(guestFlag),"reporting_frag");
            }
                ...
                public void onClick(View view) {
                    ...
                    if (oldPwd.equalsIgnoreCase("")){
                        ...
                        if (newPwd.equalsIgnoreCase(confirmPwd)){
                            ...
                            callChangePasswordApi(userNm,oldPwd,newPwd,Dashboard_nw.this,
                ...
                public void onClick(View view) {
                    ...
                    if (oldUserId.equalsIgnoreCase("")){
                        ...
                        if (newUserId.equalsIgnoreCase(confirmUserId)){
                            ...
                            callChangeUsernameApi(userNm,oldUserId,newUserId,Dashboard_nw.this,
