...
import com.orsac.android.pccfwildlife.Adapters.IncidentAnimalCasualty_Adapter;
...
public class OtherIncidentReporting extends AppCompatActivity implements LocationListener, com.google.android.gms.location.LocationListener,
        PermissionUtils.PermissionResultCallback, IncidentRecyclerAdapter.OnCheckbox_Selected_listener,
        IncidentAnimalCasualty_Adapter.OnItemAddListener, SensorEventListener {

    Toolbar toolbar;
    ImageView back;
    TextView toolbar_title;
    SearchableSpinner division_spinner,range_spinner,section_spinner,beat_spinner;
    AppCompatSpinner incidentType_spinner, incidentsubType_spinner;
    ScrollView main_ll;
    MaterialTextView dateofmov;

    TextInputEditText latdeg, latmin, latsec, londeg, lonmin, lonsec, locationname,
            noofelephants, herd, tusker, male, female, calf, death_txt,altitude_txt,accuracy_txt,remarks;
    TextInputLayout death_til,reason_death_til,death_reason_til;
    Button save_btn;
    ...
    String divisionValue = "", rangeValue = "", secValue = "", beatValue = "", incident_typeValue = "", incident_subtypeValue = "", death_str = "",incidentRemark="";
    public String divCode = "", rangeCode = "", secCode = "", beatCode = "", dateformatForAPi = "",currentDate="";
    public String division_nm = "", range_nm = "", section_nm = "", beat_nm = "", location_nm = "", lat_deg = "",
            lat_min = "", lat_sec = "", lng_degree = "", lng_min = "", lng_sec = "", fromTime = "", toTime = "", altitude="",accuracy="";

    private DBhelper DbHelper;
    SQLiteDatabase db;
    public String token = "", checkInternet_status = "", divisionNmFrom_pref = "", userId = "",incident_type_intent_str="",circle_Nm="";
    SessionManager session;
    List<String> incident_type_list = null;
    ArrayList<CheckBoxItemModel> incidentOf_arr, incident_animal_arr, incidnt_elephant_arr,fire_arr,human_casaulty_arr,crop_damage_arr;
    LinearLayout checkbox_ll, extra_animal_death_ll;
    RecyclerView incident_recyclerView;
    IncidentRecyclerAdapter adapter;
    IncidentAnimalCasualty_Adapter animalCasualty_adapter;
    public RecyclerView.LayoutManager layoutManager;
    ArrayList<CheckBoxItemModel> chekboxNm_arr;
    ArrayList<AnimalIncidentItemModel> animal_casaulty_arr;
    GPSTracker gps;
    ...
    Uri image_uri=null;
    String img_url_str="";
    private String pictureImagePath = "",imeiNo="",compass_direction="";
    Bitmap myBitmap,viewBitmap;
    ArrayAdapter<String> spinnerAdapter = null;
    ArrayList<IncidentTypeModel> incidentTypeModels,animalIncidentCasualtyModel;
    JSONArray incidentArr=new JSONArray();
    JSONArray animal_incidentArr=new JSONArray();
...
//                DatePickerDialog dpd = new DatePickerDialog(OtherIncidentReporting.this,
        ...
        incidentType_spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (incident_typeValue.equalsIgnoreCase("Animal Death")) {
                    ...
                    spinnerAdapter = new ArrayAdapter<String>(OtherIncidentReporting.this, android.R.layout.simple_spinner_item, incident_type_list);
...
//                startActivityForResult(cInt,Camera_REQUEST_CODE);
                if (!pictureImagePath.equalsIgnoreCase("")){
                    callImageViewDialog(OtherIncidentReporting.this,
                            viewBitmap);
                }else {
...
//                openBackCamera();
        ...
        save_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if (incident_typeValue.equalsIgnoreCase("Select Incident Type")) {
                ...
                else if (!incident_typeValue.equalsIgnoreCase("Others")
                        && !incident_typeValue.equalsIgnoreCase("Select Incident Type")) {

                    if (chekboxNm_arr.size()>0){
                        ...
                        for(int i=0;i<chekboxNm_arr.size();i++) {
                            if (chekboxNm_arr.get(i).getCheckbox_item_value().equalsIgnoreCase("0")) {
                                ...
                                callInitializeView();
                                dynamicAlertDialog(OtherIncidentReporting.this, "Please check your data before save !", "Warning", "Yes");

                            }
                        }

                    }else {
                        Snackbar.make(main_ll, "Please provide incident data !", Snackbar.LENGTH_SHORT).show();
                    }

                }else if (incident_typeValue.equalsIgnoreCase("Others")){
                    if (remarks.getText().toString().trim().equalsIgnoreCase("")){
                        Snackbar.make(main_ll, "Please enter remark !", Snackbar.LENGTH_SHORT).show();
                    }
                    else {
...
//                    if (incident_typeValue.equalsIgnoreCase("Animal Casualty")){
//
//                        //for animal casualty model arr
//                        animalIncidentCasualtyModel.clear();
//                        for (int i=0;i<animal_casaulty_arr.size();i++){
//                            if (animal_casaulty_arr.get(i).isShow() && !animal_casaulty_arr.get(i).getItem_nm().equalsIgnoreCase("")){
//                                animalIncidentCasualtyModel.add(new IncidentTypeModel(animal_casaulty_arr.get(i).getItem_nm(),
//                                        animal_casaulty_arr.get(i).getItem_value()));
//                            }
//
//                        }
//                        if (animalIncidentCasualtyModel.isEmpty()){
//
//                        }else {
////                            Toast.makeText(OtherIncidentReporting.this, ""+animalIncidentCasualtyModel.toString(), Toast.LENGTH_SHORT).show();
//                            Log.i("animalincident_json",animalIncidentCasualtyModel.toString());
//                        }
//
//                    }else {
                        //for other incident type
                        if (chekboxNm_arr.size()>0){
...
//                    }
                    ...
                    PermissionUtils.hideKeyboard(OtherIncidentReporting.this);//Hide Keyboard
...
//                        //For animal casualty
//                        for (int i=0;i<animal_casaulty_arr.size();i++){
//                            if (animal_casaulty_arr.get(i).getItem_nm().equalsIgnoreCase("")) {
////                                Snackbar.make(main_ll, "Please add incident type data ", Snackbar.LENGTH_SHORT).show();
//                            }
//                            else {
//                                JSONObject animalcasualty_json=new JSONObject();
//                                if (animal_casaulty_arr.get(i).isShow() && !animal_casaulty_arr.get(i).getItem_nm().equalsIgnoreCase("")){
//
//                                    animalcasualty_json.put("name",animal_casaulty_arr.get(i).getItem_nm());
//                                    animalcasualty_json.put("value",animal_casaulty_arr.get(i).getItem_value());
//
//                                    animal_incidentArr.put(animalcasualty_json);
//                                }else {
//
//                                }
//
...
//                    dynamicAlertDialog(OtherIncidentReporting.this, "Please check your data before save !", "Warning", "Yes");
    ...
    public void initData() {
        ...
        try {
            ...
            reason_death_til = findViewById(R.id.reason_death_til);
            death_reason_til = findViewById(R.id.death_reason_til);
            incidentTypeModels=new ArrayList<>();
            animalIncidentCasualtyModel=new ArrayList<>();
            ...
            commonMethods=new CommonMethods(OtherIncidentReporting.this);
            DbHelper = new DBhelper(this);
            session = new SessionManager(OtherIncidentReporting.this);
            ...
            human_casaulty_arr = new ArrayList<>();
            crop_damage_arr = new ArrayList<>();
            animal_casaulty_arr = new ArrayList<>();
//            readPhoneStatePermission();//Read PhoneStatePermission
            ...
            permissionUtils = new PermissionUtils(OtherIncidentReporting.this);
            permissions.add(Manifest.permission.ACCESS_FINE_LOCATION);
            permissions.add(Manifest.permission.ACCESS_COARSE_LOCATION);
            permissionUtils.check_permission(permissions, "Need GPS permission for getting your location", 1);

            reason_death_til.setVisibility(View.GONE);
            death_reason_til.setVisibility(View.GONE);
            ...
            getLocation();
            permissionHelperClass = new PermissionHelperClass(OtherIncidentReporting.this);
            ...
            toolbar_title.setText(R.string.fire_report);
...
//        incident_recyclerView.setNestedScrollingEnabled(false);//It stop lagging in recyclerview
            layoutManager = new LinearLayoutManager(OtherIncidentReporting.this);
    ...
    public Location getLocation() {
        try {
            ...
            gps=new GPSTracker(OtherIncidentReporting.this);
...
//                        googleApiClientHelperClass.buildGoogleApiClient();
                        gps.showSettingsAlert(OtherIncidentReporting.this);
                        callGoogleApiClient();
                    }else {
...
//        final ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(getApplicationContext(), R.layout.spinneritem, rangeName);
    ...
    public void callGoogleApiClient(){
        try {
            ...
            googleApiClientHelperClass = new GoogleApiClientHelperClass(OtherIncidentReporting.this);
            googleApiClientHelperClass.setConnectionListener(new GoogleApiClientHelperClass.ConnectionListener() {
                ...
                public void onConnected(Bundle bundle) {
                    if (ActivityCompat.checkSelfPermission(OtherIncidentReporting.this, Manifest.permission.ACCESS_FINE_LOCATION) !=
                            PackageManager.PERMISSION_GRANTED &&
                            ActivityCompat.checkSelfPermission(OtherIncidentReporting.this, Manifest.permission.ACCESS_COARSE_LOCATION) !=
                                    PackageManager.PERMISSION_GRANTED) {
                        // TODO: Consider calling
                        //    ActivityCompat#requestPermissions
...
//                        Toast.makeText(ElephantReport.this, "Getting location...", Toast.LENGTH_SHORT).show();
    ...
    public void saveIncidentReportData_inLocal(IncidentReportingData incidentReportingData, String message) {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(new ContextThemeWrapper(OtherIncidentReporting.this, R.style.AlertDialogCustom));
        alertDialogBuilder.setMessage(message);
        alertDialogBuilder.setCancelable(false);
        alertDialogBuilder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                OtherIncidentReporting.this.startActivity(new Intent(OtherIncidentReporting.this, OtherIncidentReporting.class));
                OtherIncidentReporting.this.finish();
            }
        });
                ...
                builder.setMessage(message)
                        ...
                        .setPositiveButton("Save", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                //Save in SQLITE
                                IncidentReportingData incidentReportingData=null;
                                if (incident_typeValue.equalsIgnoreCase("Animal Casualty")){
                                     incidentReportingData= new IncidentReportingData(division_nm,range_nm,section_nm,beat_nm,location_nm,
                                            currentDate, lat_deg, lat_min, lat_sec, lng_degree, lng_min, lng_sec,img_url_str,"NA",
                                            incident_typeValue.toLowerCase(),animal_incidentArr.toString(),circle_Nm,userId,imeiNo,altitude,accuracy
                                             ,incidentRemark,"");
                                }else {
                                     incidentReportingData= new IncidentReportingData(division_nm,range_nm,section_nm,beat_nm,location_nm,
                                            currentDate, lat_deg, lat_min, lat_sec, lng_degree, lng_min, lng_sec,img_url_str,"NA",
...
//
    ...
    public void oncheckBox_Click(AppCompatCheckBox checkBox){
        ...
        checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                ...
                if (isChecked){
                    Toast.makeText(OtherIncidentReporting.this, ""+compoundButton.getText(), Toast.LENGTH_SHORT).show();

                }else {
                    Toast.makeText(OtherIncidentReporting.this, ""+compoundButton.getText()+" Not checked !", Toast.LENGTH_SHORT).show();
    ...
    public void callForCheckBoxAdapter() {
        try {
            ...
            fire_arr.clear();
            human_casaulty_arr.clear();
            crop_damage_arr.clear();
            animal_casaulty_arr.clear();
            ...
            if (incident_typeValue.equalsIgnoreCase("Damage through Elephant")) {
                ...
                adapter=new IncidentRecyclerAdapter(OtherIncidentReporting.this,incidentOf_arr,extra_animal_death_ll,this);
...
//                incident_animal_arr.add(new CheckBoxItemModel(false,"Goat","",0));
                ...
                incident_recyclerView.setMinimumHeight(350);
                adapter=new IncidentRecyclerAdapter(OtherIncidentReporting.this,incident_animal_arr,extra_animal_death_ll,this);
                incident_recyclerView.setAdapter(adapter);
                adapter.notifyDataSetChanged();
            }
            else if (incident_typeValue.equalsIgnoreCase("Elephant on Road")) {
                ...
                incident_recyclerView.setMinimumHeight(100);
                adapter=new IncidentRecyclerAdapter(OtherIncidentReporting.this,incidnt_elephant_arr,extra_animal_death_ll,this);
                incident_recyclerView.setAdapter(adapter);
                adapter.notifyDataSetChanged();
            }else if (incident_typeValue.equalsIgnoreCase("Elephant Found In Pit/Dug Well")) {
                ...
                incident_recyclerView.setAdapter(adapter);
                adapter.notifyDataSetChanged();
            }else if (incident_typeValue.equalsIgnoreCase("Elephant Injured/Sick")) {
            ...
            else if (incident_typeValue.equalsIgnoreCase("Cattle/Domestic Animal Kill")){
                incidnt_elephant_arr.add(new CheckBoxItemModel(false,"Injured","",0));
                incidnt_elephant_arr.add(new CheckBoxItemModel(false,"Kill","",0));
                ...
                fire_arr.add(new CheckBoxItemModel(false,"Forest Land","",0));
                fire_arr.add(new CheckBoxItemModel(false,"Other Land","",0));

                incident_recyclerView.setMinimumHeight(150);
                adapter=new IncidentRecyclerAdapter(OtherIncidentReporting.this,fire_arr,extra_animal_death_ll,this);
                incident_recyclerView.setAdapter(adapter);
                adapter.notifyDataSetChanged();
            }
            else if (incident_typeValue.equalsIgnoreCase("Human Injury/Kill")){
                human_casaulty_arr.add(new CheckBoxItemModel(false,"Human","",0));

                incident_recyclerView.setMinimumHeight(100);
                adapter=new IncidentRecyclerAdapter(OtherIncidentReporting.this,human_casaulty_arr,extra_animal_death_ll,this);
                incident_recyclerView.setAdapter(adapter);
                adapter.notifyDataSetChanged();
            }
            else if (incident_typeValue.equalsIgnoreCase("House Damage")){
                crop_damage_arr.add(new CheckBoxItemModel(false,"House Damage","",0));

                incident_recyclerView.setMinimumHeight(100);
                adapter=new IncidentRecyclerAdapter(OtherIncidentReporting.this,crop_damage_arr,extra_animal_death_ll,this);
                incident_recyclerView.setAdapter(adapter);
                adapter.notifyDataSetChanged();
            }
            else if (incident_typeValue.equalsIgnoreCase("Animal Casualty")) {
                animal_casaulty_arr.add(new AnimalIncidentItemModel( "", "",true));

                incident_recyclerView.setMinimumHeight(150);
                animalCasualty_adapter = new IncidentAnimalCasualty_Adapter(OtherIncidentReporting.this, animal_casaulty_arr,this);
                incident_recyclerView.setAdapter(animalCasualty_adapter);
                animalCasualty_adapter.notifyDataSetChanged();
            }
            else if (incident_typeValue.equalsIgnoreCase("Crop Damage")){

                fire_arr.add(new CheckBoxItemModel(false,"Crop","",0));
...
//        incident_recyclerView.setNestedScrollingEnabled(false);//It stop lagging in recyclerview
            ...
            animalCasualty_adapter=new IncidentAnimalCasualty_Adapter(OtherIncidentReporting.this,animal_casaulty_arr,this);
            recyclerView.setAdapter(animalCasualty_adapter);
            animalCasualty_adapter.notifyDataSetChanged();
...
//                            image_uri=getImageUri(OtherIncidentReporting.this,bp);
...
//                                camera_img.setImageBitmap(myBitmap);
                                image_uri=getImageUri(OtherIncidentReporting.this,myBitmap);
                                img_url_str=getRealPathFromURI(image_uri);
...
//                            callCompassDirection();
                            ...
                            callCameraGeotagDialog(OtherIncidentReporting.this,myBitmap,latitude,longitude,
    ...
    private Uri getImageUri(Context applicationContext, Bitmap photo) {
        ...
        String path = MediaStore.Images.Media.insertImage(OtherIncidentReporting.this.getContentResolver(), photo, "incident_report"+ Calendar.getInstance().getTime(), null);
    ...
    private void openBackCamera() {
        try {
            ...
            if(Build.VERSION.SDK_INT >= 29) {
                ...
                Uri outputFileUri = FileProvider.getUriForFile(OtherIncidentReporting.this,
...
//                    Toast.makeText(IncidentReportingActivity.this, "Taking Screenshot", Toast.LENGTH_SHORT).show();
                        ...
                        image_uri=getImageUri(OtherIncidentReporting.this,bm);
...
//            if (ActivityCompat.checkSelfPermission(OtherIncidentReporting.this, Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
//                ActivityCompat.requestPermissions(OtherIncidentReporting.this, new String[]{Manifest.permission.READ_PHONE_STATE}, IMEI_REQUEST_CODE);
//                return;
//            }
            Random r = new Random();
...
//            animal_casaulty_arr.clear();
    ...
    public void removeItem(int position) {
        try {
            animal_casaulty_arr.get(position).setShow(false);
            animalCasualty_adapter.notifyDataSetChanged();
        }catch (Exception e){
            e.printStackTrace();
        }
    }
    public void callInitializeView(){
        try {
            incident_typeValue = incidentType_spinner.getSelectedItem().toString();
            incident_subtypeValue = incidentsubType_spinner.getSelectedItem().toString();
//            division_nm = division_spinner.getSelectedItem().toString();
...
//            beat_nm = beat_spinner.getSelectedItem().toString();
            ...
            //----Change to blank for division,range,section,beat
            division_nm = "";
            range_nm = "";
            section_nm = "";
            beat_nm = "";
